...
class EncodingUtils
{
	 ...
	 * @var array
	 */
	private static $entityTable = array(
			'quot'     => '&#34;',
			'amp'      => '&#38;',
			'lt'       => '&#60;',
			'gt'       => '&#62;',
	 ...
	 * @return string
	 */
	public static function htmlConvertEntities($string) {
		return preg_replace_callback('/&([a-zA-Z][a-zA-Z0-9]+);/S',
				array(__CLASS__, 'convertEntity'), $string);
	}
	 ...
	 * @return string
	 */
	public static function convertEntity($matches) {
		// Entity not found? Destroy it.
		return isset(self::$entityTable[$matches[1]]) ? self::$entityTable[$matches[1]] : '';
	}
}
